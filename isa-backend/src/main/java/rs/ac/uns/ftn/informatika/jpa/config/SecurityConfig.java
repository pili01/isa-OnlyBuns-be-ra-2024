...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                .antMatchers("/ws/**","/api/users/register", "/api/users/verify", "/api/users/login", "/register",
                        "/v3/api-docs", "/v3/api-docs/swagger-config", "/swagger-resources/**", "/swagger-ui.html",
                        "/webjars/**", "/swagger-ui/**", "/api/posts", "/api/users/profile/**",
                        "/api/posts/allPaged", "/api/posts/all", "/api/posts/images","/api/users/allFollowersPaged","/api/users/allFollowingsPaged","/api/careLocations")
                .permitAll()
                .and()
                .rememberMe()
