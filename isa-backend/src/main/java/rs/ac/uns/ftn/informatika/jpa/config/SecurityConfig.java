...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                .antMatchers("/api/users/register","/api/users/getUserByName/{username}","/api/posts/allPostComments","/api/posts/allPaged", "/api/users/verify", "/api/users/login", "/register",
